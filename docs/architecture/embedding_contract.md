...
- [ADR-010 — SentenceEmbedder backend contract](decision-log/ADR-010-sentence-embedder-backend-contract.md) — the *short normative reference* for this document. The ADR is the right artifact to cite from a PR review (`ADR-010 §3.5 Gate 1`); this document is the long-form spec the ADR ratifies.
