...
| [eyes-open-closed-step0-preregistration_v1.md](eyes-open-closed-step0-preregistration_v1.md) | EEG Step 0 | Pre-registration (frozen before post-selection session 1) |
